...
const INPUT_BOX_STYLES =
  "appearance-none block w-full text-sm rounded-md text-gray-700 border border-gray-300 p-3 placeholder-neutral-500 shadow-sm focus:border-2 focus:border-neutral-500 focus:outline-none focus:ring-neutral-500 active:border-neutral-500 cursor-text";
